...
func TestProviderConfigFromMachine(t *testing.T) {
	...
	machineClass := &machinev1.MachineClass{ObjectMeta: metav1.ObjectMeta{Namespace: "openshift-cluster-api", Name: "testClass"}, ProviderSpec: *encodedProviderSpec.Value}
	testCases := []struct{ machine *machinev1.Machine }{{machine: &machinev1.Machine{ObjectMeta: metav1.ObjectMeta{Name: "configFromSpecProviderConfigValue", Namespace: "", Labels: map[string]string{"foo": "a"}}, TypeMeta: metav1.TypeMeta{Kind: "Machine"}, Spec: machinev1.MachineSpec{ProviderSpec: *encodedProviderSpec}}}, {machine: &machinev1.Machine{ObjectMeta: metav1.ObjectMeta{Name: "configFromClass", Namespace: "", Labels: map[string]string{"foo": "a"}}, TypeMeta: metav1.TypeMeta{Kind: "Machine"}, Spec: machinev1.MachineSpec{ProviderSpec: machinev1.ProviderSpec{ValueFrom: &machinev1.ProviderSpecSource{MachineClass: &machinev1.MachineClassRef{ObjectReference: &corev1.ObjectReference{Kind: "MachineClass", Name: "testClass", Namespace: "openshift-cluster-api"}}}}}}}}
